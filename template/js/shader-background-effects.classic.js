...
const ZYO_SHADER_BACKGROUND_OFFSET = 8;

const zyoShaderBackgroundPresets = {
...
const zyoChromaWavesProps = Object.freeze({
    color: '#ffffff',
    brightness: 1,
    speed: 0.55,
    frequency: 0.75,
...
function getShaderBackgroundRenderMode() {
...
function getShaderBackgroundQuality(options = {}) {
...
function zyoShaderEffectFromBackgroundValue(value) {
    const id = Number(value || 0) - ZYO_SHADER_BACKGROUND_OFFSET;
    return zyoShaderBackgroundPresets[id] ? id : 0;
}

function createShaderBackgroundEffect(target, options = {}) {
...
function renderShaderBackgroundPreviews(root = document, options = {}) {
...
function captureShaderBackgroundPreview(options = {}) {
    const effect = normalizeEffect(options.effect);
...
// expose public api
window.ZYO_SHADER_BACKGROUND_OFFSET = ZYO_SHADER_BACKGROUND_OFFSET;
window.zyoShaderBackgroundPresets = zyoShaderBackgroundPresets;
window.zyoChromaWavesProps = zyoChromaWavesProps;
window.getShaderBackgroundRenderMode = getShaderBackgroundRenderMode;
window.getShaderBackgroundQuality = getShaderBackgroundQuality;
window.zyoShaderEffectFromBackgroundValue = zyoShaderEffectFromBackgroundValue;
window.createShaderBackgroundEffect = createShaderBackgroundEffect;
window.renderShaderBackgroundPreviews = renderShaderBackgroundPreviews;
window.captureShaderBackgroundPreview = captureShaderBackgroundPreview;
})();
